...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Log.i("TOKEN", "WORKING METHOD: GENERATING TOKEN...");
            try {

                Thread.sleep(2000);
                //Local IP Address
                final String url = "http://10.10.6.24:8080/token/generate-token";
...
//                final String url = "http://10.0.2.2:8080/token/generate-token";
                ...
                credentials.setUsername(mEmail.toString());
                credentials.setPassword(mPassword.toString());
                editor.putString("token","Bearer " +
                        new JSONObject(restTemplate
                                .postForObject(url, credentials, String.class))
                                .getString("token"))
                                .apply();
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Log.i("TOKEN", sp.getString("token","DEFAULT"));
